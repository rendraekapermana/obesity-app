...
def generate_advice(prediction, data):
    ...
    # General advice based on obesity category
    ...
    else:  # Normal weight or other categories
    ...
    # Time using technology (sedentary time)
    if data["TUE"] >= 2:
    ...
    # Transportation mode - encourage more active transport
